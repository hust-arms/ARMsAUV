...
#include <iostream>
	...
	// det_phi_ = line_dir - yaw;
        ...
        double r = this->los_ctrl_param_.kp_ * (det_phi_ - det_last_) + this->los_ctrl_param_.ki_ * det_phi_ + this->los_ctrl_param_.kd_ * (det_phi_ - 2 * det_last_ + det_pre_);
	this->det_sum_ += det_phi_;
	// double r = this->los_ctrl_param_.kp_ * det_phi_ + this->los_ctrl_param_.ki_ * this->det_sum_ + this->los_ctrl_param_.kd_ * (this->det_phi_ - this->det_last_);
