function [taus_dx, taus_dy, taus_dz, taus_dphi, taus_dtheta, taus_dpsi, is_qt_disturb] = disturb_cal_gaussian(x_qt, y_qt, z_qt, x_auvb, y_auvb, z_auvb, x_w, y_w, z_w, num, phi, theta, psi, t)
%% 转换AUV艇体上坐标点到惯性坐标系
...
%% 计算扰动作用
for k=1:num
[a_xdamp, a_ydamp, a_zdamp, is_qt_disturb] = disturb_gen_comp(x_qt, y_qt, z_qt, x_auv(k), y_auv(k), z_auv(k), t);
